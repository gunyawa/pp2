...
back_surf = pygame.image.load('lab7/1/graphs/clock.jpg').convert_alpha()
back_surf = pygame.transform.scale(back_surf, (800, 550))

left_h = pygame.image.load('lab7/1/graps/left.png').convert_alpha()
left_h_rect = left_h.get_rect(center = (380, 275))
right_h = pygame.image.load('lab7/1/graphs/right.png').convert_alpha()
